...
class PlaylistBody {
  ...
  PlaylistBody(
      {this.userId, this.platform, this.image, this.token, this.queueData});

  PlaylistBody.fromJson(Map<String, dynamic> json) {
    userId = json['user_id'];
    ...
    if (json['queueData'] != null) {
      queueData = <QueueData>[];
      json['queueData'].forEach((v) {
        queueData!.add(new QueueData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.queueData != null) {
      data['queueData'] = this.queueData!.map((QueueData v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class QueueData {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['href'] = this.href;
    if (this.items != null) {
      data['items'] = this.items!.map((Items v) => v.toJson()).toList();
    }
...
class Items {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = this.id;
    if (this.images != null) {
      data['images'] = this.images!.map((Images v) => v.toJson()).toList();
    }
    data['name'] = this.name;
    if (this.owner != null) {
