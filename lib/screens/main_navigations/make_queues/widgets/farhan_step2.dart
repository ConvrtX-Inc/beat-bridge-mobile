...
// import '../../../../models/spotify/getQueuesBasedOnId.dart';
// import '../../../../utils/helpers/text_helper.dart';
// import '../../../../utils/services/rest_api_service.dart';
// import '../../../../widgets/buttons/app_outlined_button.dart';
// import '../../../../widgets/music_platforms/music_platform_used.dart';
//
// ///Step Two
...
//
//   List<GetTrackAgainstQueueId> peopleList = <GetTrackAgainstQueueId>[];
//   bool hasError = false;
//   String? userID ;
//   APIServices songList = APIServices();
//
//   @override
...
//
//     songList.getAllUserTrackAgainstUserId('fca68d67-9510-4244-8279-262acada2631');
//   }
//
//   @override
...
//   }
//
//   Future<List<GetTrackAgainstQueueId>> getPeopleList() async {
//     if (peopleList.isEmpty) {
//       final APIStandardReturnFormat result = await APIServices().getAllUserTrackAgainstUserId('fca68d67-9510-4244-8279-262acada2631');
//       final List<GetTrackAgainstQueueId> peoples = <GetTrackAgainstQueueId>[];
//       final List<GetTrackAgainstQueueId> allusers = <GetTrackAgainstQueueId>[];
//       final dynamic jsonData = jsonDecode(result.successResponse);
//       if (result.statusCode == 200) {
//         for (final dynamic res in jsonData) {
//           final GetTrackAgainstQueueId user = GetTrackAgainstQueueId.fromJson(res);
//           //log(user.email.toString());
//           allusers.add(user);
//           peoples.add(GetTrackAgainstQueueId(
//             id: user.id.toString(),
//             name: user.name,
//           ));
//         }
...
//                     borderRadius: BorderRadius.circular(8),
//                     image: DecorationImage(
//                       image: AssetImage(peopleList[index]?.trackData?.track?.album?.images?[index]?.url ?? 'Empty'),
//                       fit: BoxFit.fitHeight,
//                     )),
//               )),
//           Column(
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: <Widget>[
//               Text(peopleList[index].name ?? 'Empty',
//                   style: TextStyle(
//                       color: AppColorConstants.roseWhite,
//                       fontWeight: FontWeight.w600,
//                       fontSize: 14)),
//               SizedBox(height: 6.h),
//               Text('${peopleList[index].trackData?.track?.album?.totalTracks} Tracks',
//                   style: TextStyle(
...
//                           image: NetworkImage(
//                               peopleList[index]?.trackData?.track?.album?.images?[index]?.url ?? 'Empty'),
//                           fit: BoxFit.cover,
//                         )),
//                   )),
//               Column(
...
//   }
//
//   Widget buildPeopleUI() => FutureBuilder<List<GetTrackAgainstQueueId>>(
//     future: getPeopleList(),
//     builder:
//         (BuildContext context, AsyncSnapshot<List<GetTrackAgainstQueueId>> snapshot) {
//       switch (snapshot.connectionState) {import 'dart:convert';
//       import 'dart:developer';
//
//       import 'package:beatbridge/constants/app_constants.dart';
//       import 'package:beatbridge/constants/app_list.dart';
