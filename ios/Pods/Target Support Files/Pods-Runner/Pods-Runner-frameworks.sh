...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/bs_flutter_modal/bs_flutter_modal.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/bs_flutter_utils/bs_flutter_utils.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/playify/playify.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/system_settings/system_settings.framework"
